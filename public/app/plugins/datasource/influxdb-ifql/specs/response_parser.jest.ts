...
describe('influxdb ifql response parser', () => {
  ...
  describe('getNameFromRecord()', () => {
    it('expects name based on measurements and tags', () => {
      const record = {
        "": "", "result": "", "table": "0",
        "_start": "2018-06-02T06:35:25.651942602Z", "_stop": "2018-06-02T07:35:25.651942602Z",
        "_time": "2018-06-02T06:35:31Z", "_value": "0", "_field": "usage_guest",
        "_measurement": "cpu", "cpu": "cpu-total", "host": "kenobi-3.local"
      };
